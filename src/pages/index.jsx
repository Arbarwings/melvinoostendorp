          ...
          <Columns>
            ...
            <Columns.Column size={9} style={{ position: 'relative' }}>
              <FlexCard triangle={FlexCard.TRIANGLE.LEFT}>
                <span>
                  I&apos;m Melvin Oostendorp, a Full-Stack developer from the Netherlands. I&apos;m
                  a motivated developer that wants to learn and work with the latest technologies.
                  My colleagues describe me as a helpful and passionate person. My goal is to
                  deliver secure and user-friendly applications.
                </span>
              </FlexCard>
            </Columns.Column>
          </Columns>
          ...
          <Columns className="skills">
            <Columns.Column size={4}>
              <FlexCard color={FlexCard.COLORS.BLUE}>
                ...
                <p>
                  I love working in JavaScript frameworks like ReactJS and create beautiful
                  websites.
                </p>
              </FlexCard>
            </Columns.Column>
            <Columns.Column size={4}>
              <FlexCard color={FlexCard.COLORS.YELLOW}>
                ...
                <h3>Microservices</h3>
                <p>
                  Most of the applications I make are based on Docker with continuous integration
            ...
            <Columns.Column size={4}>
              <FlexCard color={FlexCard.COLORS.RED}>
                ...
                <h3>Team Player</h3>
                <p>
                  I enjoy working in a team environment, where I can share my knowledge and learn
                  from others.
                </p>
              </FlexCard>
            </Columns.Column>
          ...
          <Columns>
            ...
            <Columns.Column>
              ...
              <Timeline.Item
                  ...
                  startYear="Jan 2022"
                  title="Lead Front-End Developer at Zig"
                />
                <Timeline.Item
                  type={Timeline.Item.TYPE.WORK}
                  startYear="Feb 2021"
                ...
                >
                  ...
                  Microsoft Hololens. It can recognize the model of a specific network switch, and
                  it shows the user manual to the user.
                </Timeline.Item>
                <Timeline.Item
                  type={Timeline.Item.TYPE.WORK}
                  startYear="Jan 2019"
                ...
                >
                  ...
                  cryptocurrency trading bots. Those bots can handle multiple exchanges, like
                  Binance and BitMEX at the same time. It also supports a wide range of
                ...
                >
                  Together with a fellow student, we created a new funnel (ordering process)
                  proposal for the Mijndomein website.
                </Timeline.Item>
              </Timeline>
            </Columns.Column>
          </Columns>
